...
| Local token logs inflate an API-price estimate | Allowlist token/model fields, bound streamed lines, deduplicate filesystem and cumulative identities, contain counter drops, exclude unresolved forks and unknown models, and label incomplete coverage as partial |
